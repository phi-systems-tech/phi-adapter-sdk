...
// The registry that keeps a worker which missed its stop deadline now lives
// in abandoned_threads.h: the loop execution backend hands over a thread the
// same way, and two copies of that reasoning is one too many.
